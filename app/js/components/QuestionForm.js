        ...
        return(
            <form ref="addQuestionForm" name="addQuestion" className="clearfix" style={styleObj} onSubmit={this.submitHandle}>
                <div className="form-group">
                    ...
                    <input ref="title" type="text" className="form-control" id="qtitle" placeholder="你的问题的标题"/>
                </div>
                <textarea  ref="description" className="form-control" rows="3" placeholder="问题的描述"></textarea>
                <button type="button" className="btn btn-btn-default pull-right" onClick={this.props.onToggleForm}>取消</button>
